...
const Navbar: React.FC = () => {
  ...
  return (
    <LazyMotion features={domAnimation}>       <ul
    className={`${
      isNavOpen
  ...
  >
    <div className="container mx-auto px-4 py-3 space-y-8 items-center">
      ...
      <motion.nav
        ...
        transition={{ duration: 0.3 }}
      >
        <div className="container mx-auto px-4 py-3 z-[100000000]">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
            <img src="/clash_commander.png" alt="Logo" className="w-8 h-8 mr-2 rounded-full z-[100000000]" />
              <h1 className="text-lg font-bold z-[100000000]"><Link href="/">Clash Commander</Link></h1>
            </div>
            <div className="lg:hidden">
              <button
                className="flex items-center justify-center p-2 rounded-md text-pink-600 hover:bg-pink-200 focus:outline-none nav-icon"
                onClick={toggleNav}
              >
        ...
        <ul
          className={`${
            isNavOpen
              ? "fixed top-0 left-0 w-full h-full flex flex-col items-center justify-center bg-black bg-opacity-95 z-50"
              : "hidden"
          }`}
          onClick={() => {
            setIsNavOpen(false);
